...
class Scoring
{
    ...
    public static function tileValue(string $letter): int
    {
        $upper = strtoupper($letter);
        return self::tileValues()[$upper] ?? 0;
    }

    /**
     * Official English-language tile distribution (100 tiles including 2 blanks).
     *
